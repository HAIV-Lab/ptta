...
class DeYO(nn.Module):
    ...
    def __init__(self, model, optimizer, steps=1, episodic=False, deyo_margin=0.5*math.log(1000), margin_e0=0.4*math.log(1000)):
        ...
        args_dict = {
            'e_margin': 2.763102111592855, 'd_margin': 0.05, 'patch_len': 4,  'aug_type': 'patch', 
            'occlusion_size': 112, 'row_start': 56, 'column_start': 56, 'deyo_margin': 3.4538776394910684, 
            'deyo_margin_e0': 2.763102111592855, 'plpd_threshold': 0.3, 'fishers': 0, 'filter_ent': 1, 
            'filter_plpd': 1, 'reweight_ent': 1, 'reweight_plpd': 1
        }
        ...
        self.deyo_margin = args.deyo_margin
        self.margin_e0 = args.deyo_margin_e0
